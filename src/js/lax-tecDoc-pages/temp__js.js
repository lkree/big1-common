...
const $btns = $('<div class="tecdoc-cars-btns-wrapper">\n' +
  '        <a class="tecdoc-cars-btns-wrapper__catalog-btn tecdoc-cars-btns-wrapper__catalog-btn--first" href="#">Каталог оригинальных запчастей</a>\n' +
  '        <a class="tecdoc-cars-btns-wrapper__catalog-btn tecdoc-cars-btns-wrapper__catalog-btn--second" href="#">Каталог аналогов</a>\n' +
  '      </div>'),
      $carItem = $('.model-item');
